...
<div class="row jarak-form">
    ...
    <?php
                    ...
                    ?>
    <div class="col m3">
        <img class="galeri materialboxed" data-caption="<?php echo indoDate($row['tgl_catat']); ?>"
            src="./upload/surat_masuk/<?php echo $row['file']; ?>" />
        <a class="btn light-green darken-1" href="?page=gsk&act=fsm&id_surat=<?php echo $row['id_surat']; ?>">
...
<?php
                ...
                if (!empty($kategori_filter)) {
                    $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar WHERE kategori_surat='$kategori_filter' ORDER BY id_surat DESC LIMIT $curr, $limit");
                } else {
...
<div class="row jarak-form black-text">
    <form class="col s12" method="GET" action="">
        <input type="hidden" name="page" value="gsk"> <!-- Agar tetap di halaman galeri -->
...
<ul class="pagination">
    ...
    <?php if ($pg > 1): ?>
    <?php $prev = $pg - 1; ?>
    <li><a href="?page=gsk&pg=1"><i class="material-icons md-48">first_page</i></a></li>
    <li><a href="?page=gsk&pg=<?php echo $prev; ?>"><i class="material-icons md-48">chevron_left</i></a></li>
    <?php else: ?>
    ...
    <?php if ($i == $pg): ?>
    <li class="active waves-effect waves-dark"><a href="?page=gsk&pg=<?php echo $i; ?>"> <?php echo $i; ?> </a></li>
    <?php else: ?>
    <li class="waves-effect waves-dark"><a href="?page=gsk&pg=<?php echo $i; ?>"> <?php echo $i; ?> </a></li>
    <?php endif; ?>
    <?php endif; ?>
    <?php endfor; ?>
    ...
    <?php if ($pg < $cpg): ?>
    <?php $next = $pg + 1; ?>
    <li><a href="?page=gsk&pg=<?php echo $next; ?>"><i class="material-icons md-48">chevron_right</i></a></li>
    <li><a href="?page=gsk&pg=<?php echo $cpg; ?>"><i class="material-icons md-48">last_page</i></a></li>
    <?php else: ?>
