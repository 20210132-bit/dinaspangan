...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">home</i> ARSIP
        </a>
                    ...
                    <?php
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            if (!empty($data['alamat'])) {
                                ...
                                echo '<p class="description-side">Jalan Raya Tondano Minahasa Sulawesi Utara Telp/Fax. (0358) 329806 Tondano 64471 64471</p>';
                            }
                        }
                        ?>
                </div>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="?page=kategori_surat">Tambah Kategori</a></li>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ARSIP
             hide-on-med-and-down"><i class="material-icons md-30">home</i> ARSIP</a></li>
            <li>
                <div class="grs">
                    </>
            </li>
