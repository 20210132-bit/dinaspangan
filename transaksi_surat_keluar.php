...
<div class="row">
                    ...
                    <div class="col m7">
                        <ul class="left">
                            <li class="waves-effect waves-light hide-on-small-only">
                                <a href="?page=tsk" class="judul"><i class="material-icons">drafts</i> Surat Keluar</a>
                            </li>
                    ...
                    <div class="col m5 hide-on-med-and-down">
                        <form method="post" action="?page=tsk">
                            <div class="input-field round-in-box">
                                <input id="search-desktop" type="search" name="cari"
                                    placeholder="Ketik dan tekan enter mencari data..." required>
                                <label for="search-desktop"><i class="material-icons md-dark">search</i></label>
    ...
    <!-- Search Bar Mobile (di luar nav agar responsif di HP) -->
    <div class="col s12 hide-on-med-and-up">
        <form method="post" action="?page=tsk">
            <div class="input-field round-in-box">
                <input id="search-mobile" type="search" name="cari"
                    placeholder="Cari data..." required>
                <label for="search-mobile"><i class="material-icons md-dark">search</i></label>
                <input type="submit" name="submit" class="hidden">
            </div>
        </form>
    </div>
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        ...
                                        <th width="19%">Kategori Surat<br/>Tgl Surat</th>
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    ...
                                    <th width="24%">Tujuan</th>
                                    <th width="19%">No. Surat<br/>Tgl Surat</th>
                                    <th>Kategori Surat</th> <!-- Tambahkan kolom baru -->
